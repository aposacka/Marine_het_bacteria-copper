# script to generate Fig.4 and 5 in the Frontiers manuscript. This figure compares quotas of 
# phytoplankton and geterotrophic bacteria as a function of inorganic Cu (cultured in Aquil)


library(tidyverse)
library(cowplot)

data <-read_csv("C:/Users/Ania/Bact_Stoichiometry/Frontiers/Copper_to-carbon-ratios-compilation/Copper_to-carbon-synthesis-Aquil.csv") 
...
save_plot (filename="Bact_vs_Phytos.tiff", plot= plot, base_height= 4, base_width =9.5)